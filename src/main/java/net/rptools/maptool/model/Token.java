...
//    ZoneRenderer zoneRenderer = null.getCurrentZoneRenderer();
//    Token token = zoneRenderer.getZone().getToken(getId());
//
//    if (token == null) {
//      List<ZoneRenderer> zrenderers = null.getZoneRenderers();
...
//        .putToken(null.getCurrentZoneRenderer().getZone().getId(), this);
//    null.resetTokenPanels();
//  }
//
