...
public class AssetGroup {
  ...
  // Asset refresh data
  private Map<File, AssetTS> assetTSMap = new HashMap<>();

  // Group refresh data
  private Map<File, AssetGroup> assetGroupTSMap = new HashMap<>();
